...
/**
	Symbole d'un player
	@param[in] n - numero du player
	@return le symbole du player
*/
...
/**
  Détecte les cases jouables par le player après l'initialisation du plateau, le traitement d'effectue sur tout le tableau
...
/**
  Le player choisi les coordonnées à jouer
	@param[in] quiJoue -  Un player
	@param[in,out] gr - Une grille
	@param[in] pion - Un pion
*/
...
/**
	Appelle le prochain player à jouer (Ordinateur ou player réel)
	@param[in] quiJoue - Un player
	@param[in] gr - Une grille
	@param[in] pion - Un pion
...
/**
		Donne la main au player suivant
		@param[in] quiJoue - Un player
		@return Numéro du player
*/
...
void neomix()
{
  ...
  initCasesJouables(gr);
	...
	cout << "		2) Ordinateur contre joueur" << endl;
